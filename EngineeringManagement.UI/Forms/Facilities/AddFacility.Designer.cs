namespace EngineeringManagement.UI.Forms
{
    partial class AddFacility
    {
      ...
      private void InitializeComponent()
      {
         ...
         tableLayoutPanel1.Size = new Size(311, 85);
         ...
         TxtFacilityName.Location = new Point(158, 4);
         TxtFacilityName.Name = "TxtFacilityName";
         TxtFacilityName.Size = new Size(150, 23);
         ...
         BtnOk.Enabled = false;
         BtnOk.Location = new Point(77, 47);
         BtnOk.Name = "BtnOk";
         ...
         BtnCancelar.Location = new Point(158, 47);
