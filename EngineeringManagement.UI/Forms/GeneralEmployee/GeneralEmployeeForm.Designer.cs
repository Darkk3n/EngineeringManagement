namespace EngineeringManagement.UI.Forms.GeneralEmployee
{
   partial class GeneralEmployeeForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         txtWorkPhone = new MaskedTextBox();
         ...
         label5.Location = new Point(296, 133);
         label5.Name = "label5";
         ...
         label6.Location = new Point(296, 16);
         label6.Name = "label6";
         ...
         label12.TabIndex = 12;
         label12.Text = "Telefono de Emergencia:";
         // 
         // label13
         // 
         ...
         label13.TabIndex = 13;
         label13.Text = "Nombre del telefono de emergencia:";
         // 
         // label14
         // 
         ...
         tabPage1.Size = new Size(768, 522);
         tabPage1.TabIndex = 0;
         ...
         // btnSave
         // 
         btnSave.Location = new Point(923, 7);
         ...
         // btnCancel
         // 
         btnCancel.Location = new Point(923, 36);
      ...
      private MaskedTextBox txtWorkPhone;
